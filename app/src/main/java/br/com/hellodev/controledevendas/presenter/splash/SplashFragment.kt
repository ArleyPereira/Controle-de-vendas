package br.com.hellodev.controledevendas.presenter.splash
...
import br.com.hellodev.controledevendas.databinding.FragmentSplashBinding
    ...
    private fun checkAuth() {
        findNavController().navigate(
            if (FirebaseHelper.isAutenticated()) {
                R.id.action_splashFragment_to_menu_main
            } else {
